 ...
 */
public class GetMovieReviews extends AsyncTask<String, Void, ArrayList> {
    ...
    private ArrayList getMovieDataFromJson(String moviesJsonStr)
        ...
        ArrayList<MovieAttributes> movieReviews = new ArrayList<MovieAttributes>();
        ...
        for (int i = 0; i < moviesArray.length(); i++) {
            ...
            movieReviews.add(new MovieAttributes("Review", movieData.getString("author"), movieData.getString("content")));
        }

        /*for (int i = 0; i < movieReviews.size(); i++) {
            Log.v(LOG_TAG, "MovieKeys" + movieReview.get(i));
        }*/
    ...
    protected ArrayList doInBackground(String... params) {
        ...
        try {
            ...
            String baseUrl = "http://api.themoviedb.org/3/movie/" + params[0] + "/reviews?api_key=4e55e51ed8d84ee49380b766fa500b5f";
